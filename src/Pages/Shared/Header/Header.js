      ...
      <div className="mx-auto block md:flex flex-wrap flex-row items-center">
        <div className='flex justify-between items-center'>
          <div className="flex items-center text-3xl mb-4 md:mb-0">
            <NavLink to='/' className={`${logoClass} logo cursor-pointer flex justify-center items-center`}>
              <img
                className="h-12 mr-3"
                src="https://i.ibb.co/Vpw7WDh/logo.jpg"
                alt=""
              />{" "}
              Travel vibes
            </NavLink>
        ...
        <nav id="res_nav" className="bg-transparent py-5 flex md:hidden flex-col  ">
          ...
          {user.email && (
            <NavLink
              to="/"
              className="cursor-pointer text-white bg-gradient-to-tr mt-5 to-purple-800 from-pink-300  mx-auto rounded-full px-1 py-1 flex justify-between items-center"
            >
              <span className="text-red ml-2 block">
        ...
        <nav className="h-full md:ml-auto hidden md:flex flex-wrap items-center text-base justify-center">
          ...
          {user.email && (
            <div
              to="/"
              className="lg:bg-gradient-to-tr lg:to-purple-800 lg:from-purple-300 bg-transparent rounded-full px-1 py-1 flex justify-between items-center text-white cursor-pointer"
            >
